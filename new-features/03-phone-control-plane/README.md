# Feature 03 — Phone control plane (slash commands, approval cards, mission control)

**Bundle home:** `new-features/03-phone-control-plane/`  
...
| **Technical specification** | [spec.md](./spec.md) | NF-SPEC-03 |
